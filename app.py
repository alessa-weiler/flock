            ...
            <form id="onboardingForm">
                ...
                <div class="question">
                    ...
                    <div class="input-mode-toggle">
                        <button type="button" class="input-mode-btn active" data-mode="text" data-field="defining_moment">Text</button>
                        <button type="button" class="input-mode-btn" data-mode="voice" data-field="defining_moment">Voice</button>
                    </div>
                    ...
                    <div id="voice-input-defining_moment" class="input-container" style="display: none;">
                        <div class="audio-recorder">
                            <button type="button" class="record-btn" id="record-btn-defining_moment" data-field="defining_moment">
